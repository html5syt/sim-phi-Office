...
Utils.lazyload(() => {
  ...
  for (const i of document.querySelectorAll('.main')) i.style.display = 'block';//re：配合css故意隐藏主界面并使用非源码可编译文件以显示（该文件来自当前源仓库被隐藏的lchzh3473.GitHub.io界面）
  return undefined;
});
